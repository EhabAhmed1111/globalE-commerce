...
private final ProductMapper productMapper;
    ...
    public CartItem fromDtoToCartItem(CartItemDto cartItemDto) {
        return CartItem.builder()
                ...
                .product(productMapper.fromResponseToProduct(cartItemDto.getProductResponse()))
    ...
    public CartItemDto fromCartItemToDto(CartItem cartItem) {
        return CartItemDto.builder()
                ...
                .productResponse(productMapper.fromProductToProductResponse(cartItem.getProduct()))
