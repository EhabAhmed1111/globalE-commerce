...
import com.ihab.e_commerce.data.mapper.UserMapper;
...
//    }
    ...
    public VendorsResponse getAllVendors() {
        List<User> vendors = userRepository.findAllByRole(Role.VENDOR);
        List<VendorResponse> vendorResponse =  userMapper.fromListUsersToListVendorResponses(vendors);
        return new VendorsResponse(vendorResponse, vendorResponse.size());
    }
}
