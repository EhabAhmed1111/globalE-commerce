...
-- changeset ihab:create-payment-table
...
CONSTRAINT "payment_user_fkey" FOREIGN KEY ("user_id") REFERENCES "_user"("id") ON DELETE CASCADE ON UPDATE NO ACTION,
CONSTRAINT "payment_order_fkey" FOREIGN KEY ("order_id") REFERENCES "customer_order"("id") ON DELETE CASCADE ON UPDATE NO ACTION
);
